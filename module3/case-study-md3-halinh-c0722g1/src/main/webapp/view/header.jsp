...
<header class="container">
    <nav class="navbar navbar-expand-md bg-white navbar-white fixed-top">
        <a class="nav-link navbar-brand" href="/products"><img height="50" src="view/img/background/logo1.jpg"
                                                               width="145"/></a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#">Đồ ăn thú cưng</a>
                        <a class="dropdown-item" href="#">Phụ kiện thú cưng</a>
                        <a class="dropdown-item" href="#">Mẫu thú cưng đẹp</a>
                        <a class="dropdown-item" href="${pageContext.request.contextPath}/products?action=display">Các dịch vụ chăm sóc</a>
