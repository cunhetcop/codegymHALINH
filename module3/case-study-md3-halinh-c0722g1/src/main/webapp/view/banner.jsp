...
<section class="pt-5 pb-5 mt-0 align-items-center d-flex bg-dark"
         style="height:100vh; background-size: cover; background-image: url(https://www.purina.co.uk/sites/default/files/2020-12/Understanding%20Your%20Cat%27s%20Body%20LanguageHERO.jpg);">
    ...
    <div class="carousel slide border" data-ride="carousel" id="myCarousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img alt="Leopard" class="d-block w-100" src="/view/img/background/banner1.jpg" width="100%">
                <div class="carousel-caption">
                    <a href="#">Learn more ></a>
                </div>
            </div>
            <div class="carousel-item">
                <img alt="Cat" class="d-block w-100" src="/view/img/background/banner2.png" width="100%">
                <div class="carousel-caption">
                    <a href="#">Learn more ></a>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <img alt="Lion" class="d-block w-100" src="/view/img/background/banner3.png" width="100%">
                <div class="carousel-caption">
                    <a href="#">Learn more ></a>
                </div>
            </div>
